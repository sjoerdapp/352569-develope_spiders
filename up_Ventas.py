...
class QuotesInfiniteScrollSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.ventasreit.com/newsroom/news-releases'] 
    ...
    def parse(self, response):
        ...
        for aux in auxs[0:20]:
            ...
            item['PUBSTRING'] = aux.xpath('./td[contains(@class, "pr-date")]/text()').extract_first()
            ...
            item['DOCLINK']= aux.xpath('./td/a/@href').extract_first()
             ...
             #       }
            base_url = 'https://ventasreit.gcs-web.com'
