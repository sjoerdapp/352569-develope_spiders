...
### Teleflec Incorporated 1|1
### IR Press Relesases
### works with normal get, all news from one page 
### back to 19980203
...
class QuotessSpider(scrapy.Spider):
    name = 'Teleflex_2172300ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/Teleflex_2172300ARV001/',
        }
    #custom_settings = {
    ...
    #}
    start_urls = ['https://teleflexincorporated.gcs-web.com/news-releases']
    ...
    def parse(self, response):
          ...
          for aux in auxs:
              ...
              #        }
              base_url = 'https://teleflexincorporated.gcs-web.com'
    ...
    def parse_details(self, response):
        ...
        name_regex_2=r'(\bAbout\s*Teleflex)(.|\s)*|(\bAbout.Teleflex\b)(.|\s)*|(\bABOUT.Teleflex\b)(.|\s)*|(\bABOUT\s*.TELEFLEX\b)(.|\s)*'
