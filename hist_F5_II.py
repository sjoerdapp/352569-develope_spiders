...
### F5 Networks Inc. 2|3
###  2nd Blog, 3rd Article not sraped at the moment
### normal get 
### back to 20130107


class QuotessSpider(scrapy.Spider):
    name = 'F5_Net_II_1656100ARV002'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/F5_Net_II_1656100ARV002/',
        }
    #custom_settings = {
    ...
    def parse(self, response):  # follow drop down menue for different years
         ...
         for year in years:
             aux_url = 'https://www.f5.com/company/blog/_jcr_content/root/responsivegrid/a09_article_list_fil.results.{}'
