...
### normal get request 
### goes back to 20000111


class QuotesInfiniteScrollSpider(scrapy.Spider):
    name = "SkyworksSolutions_2005800ARV001"
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/SkyworksSolutions_2005800ARV001/',
        }
    ...
    start_urls = ['http://investors.skyworksinc.com/press-releases?b1770a01_items_per_page=50&b1770a01_year%5Bvalue%5D=_none&op=Filter&b1770a01_widget_id=b1770a01&form_build_id=form-9DFkthDhmY4jE9yaMag9cQRTRvVrckH2pF3EGkQuht8&form_id=widget_form_base'] 
    ...
    #     for year in years:
    #         aux_url = 'http://investors.skyworksinc.com/media-releases/?field_nir_news_date_value%5Bmin%5D=&items_per_page=50&page={}'
    ...
    def parse(self, response):
        ...
        for aux in auxs[0:20]:
            ...
            item['PUBSTRING'] = aux.xpath('.//td[1]/text()').extract_first()
            ...
            #        }
            base_url = 'http://investors.skyworksinc.com'
...
#
    ...
    def parse_details(self, response):
        ...
        name_regex_2=r'(\bAbout\s*Skyworks)(.|\s)*|(\bAbout.Skyworks\b)(.|\s)*|(\bABOUT.Skyworks\b)(.|\s)*|(\bABOUT\s*.SKYWORKS\b)(.|\s)*'
