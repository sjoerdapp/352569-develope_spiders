...
class QuotessSpider(scrapy.Spider):
    name = 'CimarexEnergy_4352000ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/CimarexEnergy_4352000ARV001/',
        }
    #custom_settings = {
    ...
    def start_requests(self):
        headers = {
            ...
            'Origin': 'https://www.cimarex.com',
            'Referer': 'https://www.cimarex.com/investor-relations/news-and-events/news-releases/default.aspx',
        ...
        for year in list(range(2011, 2020)):  # loop iterating over different pages of ajax request
            data["year"] = year
            s_url = 'https://www.cimarex.com/Services/PressReleaseService.svc/GetPressReleaseList'
    ...
    def parse(self, response):
          ...
          for dat in body['GetPressReleaseListResult']:
              ...
              #        }
              base_url = 'https://www.cimarex.com'
