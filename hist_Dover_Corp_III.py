...
### Dover Corporation 3|3
### 3rd spider Blog
### normal ge, All News come in one page
### 2 Fehler due to sites with pictures only
### back to 20150401



class QuotessSpider(scrapy.Spider):
    name = 'Dover_Corp_III_2059600ARV003'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/Dover_Corp_III_2059600ARV003/',
        }
    #custom_settings = {
    ...
    #}
    start_urls = ['https://www.dovercorporation.com/news/blog']
