...
class QuotessSpider(scrapy.Spider):
    name = 'DiscoveryCom_I_4701100ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/DiscoveryCom_I_4701100ARV001/',
        }
    #custom_settings = {
    ...
    #}
    start_urls = ['https://ir.corporate.discovery.com']
    ...
    def parse(self, response):  # follow drop down menue for different years
         ...
         for year in years:
             aux_url = 'https://ir.corporate.discovery.com/news-releases?field_nir_news_date_value%5Bmin%5D={}#views-exposed-form-widget-news-table'
             year_url = [aux_url.format(year)][0]
             yield scrapy.Request(url=year_url, callback=self.parse_next)

    def parse_next(self, response):
          auxs = response.xpath('//div[contains(@class, "view-content")]/table//tr[not(ancestor::thead)]')
          for aux in auxs:
              ...
              #        }
              base_url = 'https://ir.corporate.discovery.com'
