...
class QuotessSpider(scrapy.Spider):
    name = 'Viacom_I_5003200ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/Viacom_I_5003200ARV001/',
        }
    #custom_settings = {
    ...
    def parse(self, response):  # follow drop down menue for different years
         years = list(range(0, 302)) # fill in years which should be scraped, always last yeat +1 as upper bound will not be element of the list
         #del years[0]  # delets first element "NULL" from list of years
         for year in years:
             aux_url = 'https://ir.viacom.com/press-releases?page={}'
    ...
    def parse_details(self, response):
        ...
        name_regexx = r'(\bAbout\s*Viacom\b)(.|\s)*|(\bAbout.Viacom\b)(.|\s)*'
