...
### normal get request 
### goes back to 20160106


class QuotesInfiniteScrollSpider(scrapy.Spider):
    name = "Chipotle_I_5018400ARV001"
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/Chipotle_I_5018400ARV001/',
        }
    ...
    def start_requests(self):  # follow drop down menue for different years
         years = list(range(0, 151, 50)) # fill in years which should be scraped, always last yeat +1 as upper bound will not be element of the list
         #del years[0]  # delets first element "NULL" from list of years
         for year in years:
             aux_url = 'https://ir.chipotle.com/news-releases?l=50&o={}'
    ...
    def parse_next(self, response):
        auxs = response.xpath('//li[@class="wd_item"]')
        for aux in auxs:
            ...
            #        }
            base_url = 'https://ir.chipotle.com'
...
#
    ...
    def parse_details(self, response):
        ...
        name_regex_2=r'(\bAbout\s*Chipotle)(.|\s)*|(\bAbout.Chipotle\b)(.|\s)*|(\bABOUT.Chipotle\b)(.|\s)*|(\bABOUT\s*.CHIPOTLE\b)(.|\s)*'
