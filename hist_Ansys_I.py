...
### Ansys Inc. 1|1
### 1st spider Investor Press Releases, 2nd spider News Center
### originally post but works with normal get 
### back to 20090226


class QuotessSpider(scrapy.Spider):
    name = 'Ansys_I_1474400ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/Ansys_I_1474400ARV001/',
    ...
    def start_requests(self):
         ...
         years = list(range(1, 40)) # fill in years which should be scraped, always last yeat +1 as upper bound will not be element of the list
