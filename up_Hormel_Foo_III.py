...
### Hormel Foods Corporation 3|4
### 3rd spider Press Releases Innovation
...
class QuotessSpider(scrapy.Spider):
    name = 'Hormel_Foo_III_2093200ARV003'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/Hormel_Foo_III_2093200ARV003/',
        }
    #custom_settings = {
    ...
    #}
    start_urls = ['https://www.hormelfoods.com/newsroom/press-releases/category/innovation/']
    ...
    def parse(self, response):  # follow drop down menue for different years
          ...
          for year in years:
              aux_url = 'https://www.hormelfoods.com/wp-json/wp/v2/posts?orderby=date&order=desc&per_page=20&exclude=27913%2C27799%2C27779&categories=33&news_type=14&content=1&page={}'
