...
class QuotessSpider(scrapy.Spider):
    name = 'MarketAxess_4587800ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/MarketAxess_4587800ARV001/',
        }
    #custom_settings = {
    ...
    def start_requests(self):  # follow drop down menue for different years
         ...
         for year in years:
             aux_url = 'https://investor.marketaxess.com/press-releases?page={}'
    ...
    def parse_next(self, response):
          ...
          for aux in auxs:
              ...
              #        }
              base_url = 'https://investor.marketaxess.com'
    ...
    def parse_details(self, response):
        ...
        name_regex_2= r'(\bAbout\s*MarketAxess)(.|\s)*|(\bAbout.MarketAxess)(.|\s)*|(\bAbout. MarketAxess\b)(.|\s)*|(\bABOUT\s*MARKETAXESS)(.|\s)*|(\bABOUT\s*MarketAxess)(.|\s)*'
