...
class QuotessSpider(scrapy.Spider):
    ...
    def parse(self, response):
          auxs = response.xpath('//tbody//tr')
          for aux in auxs:
              item = SwisscomIvCrawlerItem()
              item['PUBSTRING'] = aux.xpath('./td//div[@class="field-content"]//div[@class="field__item"]/text()').extract_first()
              item['HEADLINE']= aux.xpath('./td/div[@class="views-field views-field-field-nir-news-title"]/div[@class="field-content"]//a/text()').extract_first()
              item['DOCLINK']= aux.xpath('./td/div[@class="views-field views-field-field-nir-news-title"]/div[@class="field-content"]/a/@href').extract_first()
              #item = {
              ...
              aux_url = aux.xpath('./td/div[@class="views-field views-field-field-nir-news-title"]/div[@class="field-content"]/a/@href').extract_first()
