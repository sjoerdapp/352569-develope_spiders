...
### United Contitnetal Holdings Inc. 1|2
### 1st spider Investor Earnings releases, 2nd spider Newsroom
### normal get 
### back to 20160121
...
class QuotessSpider(scrapy.Spider):
    ...
    #}
    start_urls = ['http://ir.united.com/financial-performance/earnings-releases']
    ...
    def parse(self, response):
          ...
          for aux in auxs:
              ...
              item['PUBSTRING'] = aux.xpath('./td[@data-before="Date"]/div/text()').extract_first() # cuts out the part berfore the date as well as the /n at the end of the string
              item['HEADLINE']= aux.xpath('./td[@data-before="Title"]/div/a/text()').extract_first()
              item['DOCLINK']= aux.xpath('./td[@data-before="Title"]/div/a/@href').extract_first()
              #item = {
              ...
              aux_url = aux.xpath('./td[@data-before="Title"]/div/a/@href').extract_first()
