...
class BHGE(scrapy.Spider):
    ...
    def start_requests(self):
        headers = {
            ...
            'Referer': 'https://www.aptiv.com/newsroom',
            'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36',
            'sec-fetch-site': 'same-origin',
            'sec-fetch-mode': 'cors',
           }

        data = {"Filters":{"NewsPublishedDate":["1969-03-02","2020-12-31"]},"Group":"newsroom","ItemsPerPage":30,"OrFacets":["newstypes"],"HighlightedFields":["Title"],"Skip":0}
        #for year in list(range(2014, 2020)):  # loop iterating over different pages of ajax request
        #    data['year'] = year
        s_url = 'https://www.aptiv.com/RestApi/st/facet-search/newsroom'
