...
### UPDATES
### get latest 20 news, 50 per page
...
class QuotessSpider(scrapy.Spider):
    name = 'Nordstrom_I_3217000ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/Nordstrom_I_3217000ARV001/',
        }
    #custom_settings = {
    ...
    #}
    #start_urls = ['https://press.nordstrom.com']
    ...
    def start_requests(self):  # follow drop down menue for different years
         ...
         for year in years:
             aux_url = 'https://press.nordstrom.com/news-releases?field_nir_news_date_value%5Bmin%5D=&items_per_page=50&field_nir_news_type_target_id%5B3886%5D=3886&field_nir_news_type_target_id%5B3891%5D=3891&field_nir_news_type_target_id%5B3896%5D=3896&promote=All&page={}'
    ...
    def parse_next(self, response):
          ...
          for aux in auxs[0:20]:
              ...
              #        }
              base_url = 'https://press.nordstrom.com'
    ...
    def parse_details(self, response):
        ...
        name_regex_2=r'(\bAbout\s*Nordstrom\b)(.|\s)*|(\bAbout.Nordstrom\b)(.|\s)*|(\bABOUT.NORDSTROM\b)(.|\s)*'
