...
### 2nd Press Releases, 3rd Corporate News
### normal get 
### back to 20160405


class QuotessSpider(scrapy.Spider):
    name = 'FlirSys_II_1221400ARV002'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/FlirSys_II_1221400ARV002/',
        }
    #custom_settings = {
    ...
    #}
    start_urls = ['https://www.flir.com/news-center/press-releases']
    ...
    def parse(self, response):  # follow drop down menue for different years
         ...
         for year in years:
             aux_url = 'https://www.flir.com/news-center/press-releases/?page={}'
