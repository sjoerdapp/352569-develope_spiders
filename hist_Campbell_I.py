...
class QuotessSpider(scrapy.Spider):
    name = 'Campbell_I_2038400ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/Campbell_I_2038400ARV001/',
        }
    #custom_settings = {
    ...
    def parse(self, response):  # follow drop down menue for different years
         years = list(range(1, 108)) # fill in years which should be scraped, always last yeat +1 as upper bound will not be element of the list
         #del years[0]  # delets first element "NULL" from list of years
         for year in years:
             aux_url = 'https://www.campbellsoupcompany.com/newsroom/press-releases/page/{}/'
