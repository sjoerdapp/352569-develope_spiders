...
class QuotessSpider(scrapy.Spider):
    ...
    def parse(self, response):  # follow drop down menue for different years
         ...
         cookies = {'SimpleSAMLSessionID': 'bdd293be1c7e2ff2cd2314cfbfc96bff',
                    #'_ga': 'A1.2.890213369.1563141441',
                    #'cookieconsent_status': 'dismiss',
                    #'_gid': 'GA1.2.672569217.1563273511',
                    }

         year_url = 'https://fmccorp.gcs-web.com/news?bb200a3a_year%5Bvalue%5D=_none&op=Filter&bb200a3a_widget_id=bb200a3a&form_build_id=form--IIuTASJ85cKLpZdZ_TVqCV9H_Se3IFJzNErOONrODI&form_id=widget_form_base'
         yield scrapy.Request(url=year_url, cookies=cookies, callback=self.parse_next)
    ...
    def parse_next(self, response):
          ...
          for aux in auxs[0:20]:
              ...
              #        }
              base_url = 'https://fmccorp.gcs-web.com'
