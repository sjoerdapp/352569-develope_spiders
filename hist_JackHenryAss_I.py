...
### Jack Henty & Associates Inc. 1|2
### 1st spider Press Releases, 2nd Media Releases
### normal get 
### back to 20000119


class QuotessSpider(scrapy.Spider):
    name = 'JackHenryAss_I_7864000ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/JackHenryAss_I_7864000ARV001/',
        }
    #custom_settings = {
    ...
    #}
    start_urls = ['https://www.jackhenry.com']
    ...
    def parse_next(self, response):
          ...
          for aux in auxs:
              ...
              #        }
              base_url = 'https://ir.jackhenry.com'
    ...
    def parse_details(self, response):
        ...
        name_regex = r'(Forward(.|\s*)Looking\s*Statements)(.|\s)*|(Statements\s*made\s*in\s*this\s*news\s*release\s*that\s*are\s*not\s*historical\s*facts\s*are\s*forward(.|\s*)looking\s*information.)(.|\s)*'
