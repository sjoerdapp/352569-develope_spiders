...
### A.O. Smith Corporation 1|2
### 1st spider Investor Press Releases, 2nd spider Current News
### normal get 
### back to 19980119


class QuotessSpider(scrapy.Spider):
    name = 'AoSmith_I_2162500ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/AoSmith_I_2162500ARV001/',
        }
    #custom_settings = {
    ...
    #}
    start_urls = ['https://www.aosmith.com']
    ...
    def parse_next(self, response):
          ...
          for aux in auxs[0:20]:
              ...
              #        }
              base_url = 'http://investor.aosmith.com'
