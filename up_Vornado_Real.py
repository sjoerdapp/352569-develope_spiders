...
class QuotessSpider(scrapy.Spider):
    ...
    def start_requests(self):  # follow drop down menue for different years
         ...
         for year in years:
             aux_url = 'https://investors.vno.com/News/103050/NewsData?pageIndex={}'
    ...
    def parse_next(self, response):
          ...
          for aux in auxs[0:20]:
              ...
              #        }
              base_url = 'https://investors.vno.com'
    ...
    #    aux_link = response.xpath('//iframe/@src').extract_first()
    #    item = response.meta['item']
    #    request = scrapy.Request(url=aux_link, callback=self.parse_details_II)
    #    request.meta['item'] = item
    #    yield request
