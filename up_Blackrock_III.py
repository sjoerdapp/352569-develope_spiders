...
class QuotessSpider(scrapy.Spider):
    name = 'BlackRock_III_3633600ARV003'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/BlackRock_III_3633600ARV003/',
        }
    #custom_settings = {
    ...
    #}
    #start_urls = ['https://ir.blackrock.com/feed/PressRelease.svc/GetPressReleaseList?apiKey=BF185719B0464B3CB809D23926182246&LanguageId=1&bodyType=0&pressReleaseDateFilter=3&categoryId=1cb807d2-208f-4bc3-9133-6a9ad45ac3b0&pageSize=-1&pageNumber=0&tagList=&includeTags=true&year=2020&excludeSelection=1']
    ...
    def start_requests(self):
        ...
        for year in list(range(2019, 2021)):  # loop iterating over different pages of ajax request
            #data["year"] = year
            aux_url = 'https://ir.blackrock.com/feed/PressRelease.svc/GetPressReleaseList?apiKey=BF185719B0464B3CB809D23926182246&LanguageId=1&bodyType=0&pressReleaseDateFilter=3&categoryId=1cb807d2-208f-4bc3-9133-6a9ad45ac3b0&pageSize=-1&pageNumber=0&tagList=&includeTags=true&year={}&excludeSelection=1'
    ...
    def parse(self, response):
          ...
          for dat in body['GetPressReleaseListResult']:
              ...
              #        }
              base_url = 'https://ir.blackrock.com'
