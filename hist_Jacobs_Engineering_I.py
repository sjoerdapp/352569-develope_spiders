...
### classic post, get always motst nr of items per page...
### back to 20080104


class QuotessSpider(scrapy.Spider):
    name = 'Jacobs_Engineenring_I_2101100ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/Jacobs_Engineenring_I_2101100ARV001/',
        }
    #custom_settings = {
    ...
    def start_requests(self):
        headers = {
            ...
            'Origin': 'http://invest.jacobs.com',
            'Referer': 'http://invest.jacobs.com/News/Press-Releases/',
        ...
        data = {"serviceDto":{"ViewType":"2","ViewDate":"","RevisionNumber":"1","LanguageId":"1","ItemCount":105,"StartIndex":0,"Signature":"","TagList":[]},"pressReleaseBodyType":3,"pressReleaseSelection":3,"pressReleaseCategoryWorkflowId":"1cb807d2-208f-4bc3-9133-6a9ad45ac3b0","year":2019}
        for year in list(range(2008, 2020)):  # loop iterating over different pages of ajax request
            data["year"] = year
            s_url = 'http://invest.jacobs.com/Services/PressReleaseService.svc/GetPressReleaseList'
    ...
    def parse(self, response):
          ...
          for dat in body['GetPressReleaseListResult']:
              ...
              #        }
              base_url = 'http://invest.jacobs.com'
