...
class BHGE(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        #cookies = {'coveorest#lang': 'en',
        #           'BIGipServerwww.iqvia.com_http_prod_pool': '3001691298.20992.0000',
        #           'shotgun#lang': 'en',
        #           'ASP.NET_SessionId': 'bakcb52wmstf5iveejrdcjzy',
        #           'SC_ANALYTICS_GLOBAL_COOKIE': '95a14aa8f7704da38806254518d46502|False',
        #           '_gcl_au': '1.1.542620491.1570112473',
        #           '_ga': 'GA1.2.508598483.1570112473',
        #           '_gid': 'GA1.2.806944686.1570112473',
        #           'OptanonConsent': 'landingPath=https%3A%2F%2Fwww.iqvia.com%2Fnewsroom&datestamp=Thu+Oct+03+2019+16%3A21%3A13+GMT%2B0200+(Mitteleurop%C3%A4ische+Sommerzeit)&version=3.6.15',
        #           '_hjid': 'd5e82083-b2bf-479e-9a6e-5d744ccc22fa',
        #           'elqCustomerGUID': '056b8e06-3f73-4680-9f71-c8885815569f'}
    ...
    def parse(self, response):
        ...
        for dat in body['results']:
            ...
            item['PUBSTRING'] = dat['raw']['createddatemmmmddyyyy']
    ...
    def parse_details(self, response):
        ...
        item['DESCRIPTION'] = re.sub(name_regex,'' ," ".join(response.xpath('//div[@class="col-sm-8"]/h2/text() | //div[@class="page-body"]//text()[not(ancestor::img)][not(ancestor::div[@class="box__right"] or self::style or self::script or  ancestor::style or ancestor::script or ancestor::p[@id="news-body-cta"] or ancestor::div[@id="bwbodyimg"])]').extract()))
