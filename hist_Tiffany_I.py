...
### Tiffany & Co. 1|2
### 1st spider Investor Press Releases, second spider News
### normal get 
### back to 19970305


class QuotessSpider(scrapy.Spider):
    name = 'Tiffany_I_2175300ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/Tiffany_I_2175300ARV001/',
        }
    #custom_settings = {
    ...
    #}
    start_urls = ['https://investor.tiffany.com']

    def parse(self, response):  # follow drop down menue for different years
         years = list(range(0, 39)) # fill in years which should be scraped, always last yeat +1 as upper bound will not be element of the list
         #del years[0]  # delets first element "NULL" from list of years
         for year in years:
             aux_url = 'https://investor.tiffany.com/news-events/press-releases?page={}'
    ...
    def parse_next(self, response):
          ...
          for aux in auxs:
              ...
              #        }
              base_url = 'https://investor.tiffany.com'
