...
### Molson Coors Brewing Company 1|2
### 1st spider Investor Press Releases, 2nd spider news
### normal get 
### 1 Fehler due to empty news
### back to 20030724

class QuotessSpider(scrapy.Spider):
    name = 'Molson_Coor_I_3300000ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/Molson_Coor_I_3300000ARV001/',
        }
    #custom_settings = {
    ...
    #}
    start_urls = ['http://ir.molsoncoors.com']
    ...
    def parse_next(self, response):
          auxs = response.xpath('//div[@class="ModuleContentContainer"]/div[contains(@id, "divItem")]')
          if len(auxs) > 20:
            auxs = auxs[0:20]
          ...
          for aux in auxs:
              ...
              #        }
              base_url = 'http://ir.molsoncoors.com'
