...
class QuotessSpider(scrapy.Spider):
    name = 'CMS_En_2036100ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/CMS_En_2036100ARV001/',
        }
    #custom_settings = {
    ...
    def parse_details(self, response):
        ...
        name_regex = r'(Forward(.|\s*)Looking\s*Statements)(.|\s)*|(\bABOUT\s*CMS\b)(.|\s)*|(\bABOUT.CMS\b)(.|\s)*|(\bABOUT\s*Consumers\s*Energy\b)(.|\s)*|(\bABOUT.Consumers.Energy\b)(.|\s)*'
