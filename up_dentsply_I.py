...
### Dentsply Sirona 1|2
### 1st spider Investor Press Releases, 2nd spider Press and Media 
### normal get 
### back to 20080430


class QuotessSpider(scrapy.Spider):
    name = 'Dentsply_I_9424000ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/Dentsply_I_9424000ARV001/',
        }
    #custom_settings = {
    ...
    #}
    start_urls = ['https://investor.dentsplysirona.com']
    ...
    def parse(self, response):  # follow drop down menue for different years
         ...
         for year in years:
             aux_url = 'https://investor.dentsplysirona.com/press-releases?page={}'
    ...
    def parse_next(self, response):
          ...
          for aux in auxs:
              ...
              #        }
              base_url = 'https://investor.dentsplysirona.com'
