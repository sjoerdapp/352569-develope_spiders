...
class QuotesInfiniteScrollSpider(scrapy.Spider):
    ...
    start_urls = ['https://nucorirservice.nucor.com/api/newsreleases.json'] 
    ...
    def parse(self, response):  # follow drop down menue for different years
        ...
        for dat in body['newsReleases'][0]['newsCategory'][0]['newsRelease']:
            ...
            #          }
            base_url = 'https://nucorirservice.nucor.com/api/newsrelease/'
