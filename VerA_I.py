...
class QuotesInfiniteScrollSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.verisk.com/press-releases/?page=1'] 
    ...
    def parse_next(self, response):
        ...
        for aux in auxs:
            ...
            pattern = 'Jan(.*)(?= —|–|-)|Feb(.*)(?= —|–|-)|Mar(.*)(?=  —|–|-)|Apr(.*)(?= —|–|-)|May(.*)(?= —|–|-)|Jun(.*)(?= —|–|-)|Jul(.*)(?= —|–|-)|Aug(.*)(?= —|–|-)|Sep(.*)(?= —|–|-)|Oct(.*)(?= —|–|-)|Nov(.*)(?= —|–|-)|Dec(.*)(?= —|–|-)|January(.*)(?= —|–|-)|February(.*)(?= —|–|-)|March(.*)(?= —|–|-)|April(.*)(?= —|–|-)|May(.*)(?= —|–|-)|June(.*)(?= —|–|-)|July(.*)(?= —|–|-|─)|August(.*)(?= —|–|-)|September(.*)(?= —|–|-)|October(.*)(?= —|–|-)|November(.*)(?= —|–|-)|December(.*)(?= —|–|-)'
            ...
            item = {
                    #'PUBSTRING': aux.xpath('.//div[@class="catItemBody"]//p/text()').extract_first(),
                    'PUBSTRING': re.search(pattern, aux.xpath('.//div[@class="catItemBody"]//p/text()').extract_first(), re.IGNORECASE).group(0),
