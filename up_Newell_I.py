...
### UPDATES
### first two pages, latest 30 news# -*- coding: utf-8 -*-
"""
...
### UPDATES
### latest 25 news, 25 items per page

### Newell Brands inc. 1|2
### 1st spider Investor Press Releases, 2nd spider Pressroom
### normal get 
### back to 20140107


class QuotessSpider(scrapy.Spider):
    name = 'Newell_I_3178000ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/Newell_I_3178000ARV001/',
        }
    #custom_settings = {
    ...
    #}
    start_urls = ['https://ir.newellbrands.com']
    ...
    def parse_next(self, response):
          ...
          for aux in auxs:
              ...
              #        }
              base_url = 'https://ir.newellbrands.com'
