...
class QuotessSpider(scrapy.Spider):
    name = 'DaVita_3097500ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/DaVita_3097500ARV001/',
        }
    #custom_settings = {
    ...
    #}
    start_urls = ['http://pressreleases.davita.com']

    def parse(self, response):  # follow drop down menue for different years
         years = list(range(0, 1001, 50)) # fill in years which should be scraped, always last yeat +1 as upper bound will not be element of the list
         #del years[0]  # delets first element "NULL" from list of years
         for year in years:
             aux_url = 'http://pressreleases.davita.com/index.php?s=2429&l=50&o={}'
    ...
    def parse_next(self, response):
          ...
          for aux in auxs:
              ...
              #        }
              base_url = 'http://pressreleases.davita.com'
    ...
    def parse_details(self, response):
        ...
        name_regex_2=r'(\bAbout\s*DaVita)(.|\s)*|(\bAbout.DaVita)(.|\s)*|(\bABOUT.DAVITA)(.|\s)*|(\bABOUT.DaVita)(.|\s)*'
