...
class QuotesInfiniteScrollSpider(scrapy.Spider):
    ...
    def start_requests(self):  # follow drop down menue for different years
         years = list(range(0, 301, 50)) # fill in years which should be scraped, always last yeat +1 as upper bound will not be element of the list
         #del years[0]  # delets first element "NULL" from list of years
         for year in years:
             aux_url = 'https://newsroom.resmed.com/news-releases?l=50&o={}'
