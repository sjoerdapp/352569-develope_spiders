...
### normal get
### Newsroom is identical to IR Press Releases but shorter History and somewhat less news.... daher nur 1 spider
### back to 20000207


class QuotessSpider(scrapy.Spider):
    name = 'SLGreenRealty_3206200ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/SLGreenRealty_3206200ARV001/',
        }
    #custom_settings = {
    ...
    #}
    start_urls = ['https://slgreen.gcs-web.com']
    ...
    def parse(self, response):  # follow drop down menue for different years
         ...
         for year in years:
             aux_url = 'https://slgreen.gcs-web.com/press-releases?field_nir_news_date_value%5Bmin%5D=&items_per_page=50&page={}'
    ...
    def parse_next(self, response):
          ...
          for aux in auxs:
              ...
              #        }
              base_url = 'https://slgreen.gcs-web.com'
    ...
    def parse_details(self, response):
        ...
        name_regex_2=r'(\bAbout\s*SL\s*Green)(.|\s)*|(\bAbout.SL.Green\b)(.|\s)*|(\bABOUT.SL\b)(.|\s)*'
