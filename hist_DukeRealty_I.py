...
class QuotessSpider(scrapy.Spider):
    name = 'DukeRealty_I_2060900ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/DukeRealty_I_2060900ARV001/',
        }
    #custom_settings = {
    ...
    #}
    start_urls = ['https://investor.dukerealty.com/news-releases?field_nir_news_date_value%5Bmin%']
    ...
    def parse(self, response):
          ...
          for aux in auxs:
              ...
              #        }
              base_url = 'https://investor.dukerealty.com'
