...
### UPDATES
### take news of first page (last 20 news)
...
class QuotesInfiniteScrollSpider(scrapy.Spider):
    ...
    start_urls = ['https://ir.53.com/news-releases/all/all/all'] 
    ...
    def parse_details(self, response):
        ...
        item['PUBSTRING'] = re.split(r'\d+:',response.xpath('//div[@class="panel-pane pane-node-date"]/div/text()').extract_first().split('y,')[1])[0]
