...
### 1st spider Investor NEWS RELEASES, 2nd Company News Releases
### normal get
### back to 20020102
...
class QuotessSpider(scrapy.Spider):
    name = 'UniversalHealthServices_I_4655000ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/UniversalHealthServices_I_4655000ARV001/',
        }
    #custom_settings = {
    ...
    def parse_next(self, response):
          ...
          for aux in auxs:
              ...
              item['HEADLINE']= aux.xpath('.//div[contains(@class, "news-title")]/div/a[2]/text()').extract_first()
