...
### 1st spider (used to be phoenix) Investor press releases, 2nd spider Press Releases
...
class QuotessSpider(scrapy.Spider):
    ...
    #}
    start_urls = ['http://ir.loews.com/press-releases-archive?ae220a2c_year%5Bvalue%5D=_none&op=Filter&ae220a2c_widget_id=ae220a2c&form_build_id=form-aIwrcjvaRIV9mPpbjb-uJDc4ELPM5VKoFNN16Ho-2A0&form_id=widget_form_base']
