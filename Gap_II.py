...
class QuotessSpider(scrapy.Spider):
    name = 'Gap_II_1892000ARV002'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/Gap_II_1892000ARV002/',
        }
    #custom_settings = {
    ...
    #}
    start_urls = ['https://corporate.gapinc.com']
    ...
    def parse(self, response):  # follow drop down menue for different years
         ...
         for year in years:
             aux_url = 'https://corporate.gapinc.com/en-us/news/company?cultureCode=en-us&format=json&page={}'
    ...
    def parse_next(self, response):
          ...
          for aux in body:
              ...
              #        }
              base_url = 'https://corporate.gapinc.com'
    ...
    def parse_details(self, response):
        ...
        if '.pdf' in response.url.lower() or 'external.file' in response.url.lower():
            ...
            item['DESCRIPTION'] = re.sub(name_regex,'' ," ".join(response.xpath('//div[@class="article-container--body cms-content"]//text()[not(ancestor::div[@class="article-details"])][not(ancestor::div[@class="box__right"] or self::style or self::script or ancestor::style or ancestor::script or ancestor::p[@id="news-body-cta"] or ancestor::div[@id="bwbodyimg"])]').extract()), flags=re.IGNORECASE)
