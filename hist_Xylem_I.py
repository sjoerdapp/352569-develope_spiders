...
### Xylem Inc. 1|2
### 1 spider IR Press Releases, 2nd spider normal Press Releases
### normal get request 
### goes back to 20111101


class QuotesInfiniteScrollSpider(scrapy.Spider):
    name = "Xylem_I_5389600ARV001"
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/Xylem_I_5389600ARV001/',
        }
    ...
    def start_requests(self):  # follow drop down menue for different years
         ...
         for year in years:
             aux_url = 'https://xyleminc.gcs-web.com/news-events/news-releases?field_nir_news_date_value%5Bmin%5D=&items_per_page=50&page={}'
    ...
    def parse_next(self, response):
        ...
        for aux in auxs:
            ...
            #        }
            base_url = 'https://xyleminc.gcs-web.com'
