...
### UPDATES
### get latest 20 news, all news come in one page

### changed site to apx 2019-12-20, get with json
...
class QuotessSpider(scrapy.Spider):
    ...
    #}
    start_urls = ['https://newsroom.garmin.com/feed/PressRelease.svc/GetPressReleaseList?apiKey=BF185719B0464B3CB809D23926182246&LanguageId=1&bodyType=3&pressReleaseDateFilter=3&categoryId=1cb807d2-208f-4bc3-9133-6a9ad45ac3b0&pageSize=-1&pageNumber=0&tagList=&includeTags=true&year=2020&excludeSelection=1']
