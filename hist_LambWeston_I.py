...
class QuotesInfiniteScrollSpider(scrapy.Spider):
    name = "LambWeston_I_9900143ARV001"
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/LambWeston_I_9900143ARV001/',
        }
    ...
    start_urls = ['https://investors.lambweston.com'] 
    ...
    def parse_next(self, response):
        ...
        for aux in auxs:
            ...
            item['PUBSTRING'] = aux.xpath('.//p[@class="pr-date-field"]/text()').extract_first()
            ...
            #        }
            base_url = 'https://investors.lambweston.com'
    ...
    def parse_details(self, response):
        ...
        if '.pdf' in response.url.lower():
            ...
            item['DESCRIPTION'] = re.sub(name_regex,'' ," ".join(response.xpath('//div[@class="bw-release-body "]//text()[not(ancestor::div[@class="box__right"] or self::style or self::script or  ancestor::style or ancestor::script or ancestor::p[@id="news-body-cta"] or ancestor::div[@id="bwbodyimg"])]').extract()), flags=re.IGNORECASE)
