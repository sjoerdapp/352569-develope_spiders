...
### normal get 50 per page
### back to 19990216


class QuotessSpider(scrapy.Spider):
    name = 'Varian_med_I_2185900ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/Varian_med_I_2185900ARV001/',
        }
    #custom_settings = {
    ...
    #}
    start_urls = ['http://investors.varian.com']

    def parse(self, response):  # follow drop down menue for different years
         years = list(range(0, 1302, 50)) # fill in years which should be scraped, always last yeat +1 as upper bound will not be element of the list
         #del years[0]  # delets first element "NULL" from list of years
         for year in years:
             aux_url = 'http://investors.varian.com/index.php?s=31868&l=50&o={}'
    ...
    def parse_next(self, response):
          ...
          for aux in auxs:
              ...
              #        }
              base_url = 'http://investors.varian.com'
    ...
    def parse_details(self, response):
        ...
        name_regex = r'(Forward(.|\s*)Looking\s*Statements)(.|\s)*|(\bABOUT.Varian.Medical.Systems (?!\’))(.|\s)*|(\bABOUT\s*Varian\s*Medical\s*Systems (?!\’))(.|\s)*'
