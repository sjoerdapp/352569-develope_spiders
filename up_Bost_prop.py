...
class QuotesInfiniteScrollSpider(scrapy.Spider):
    ...
    start_urls = ['http://ir.bostonproperties.com/latest-news',] 
    ...
    def parse(self, response):  # follow drop down menue for different years
         ...
         for year in years:
             aux_url = 'http://ir.bostonproperties.com/latest-news?items_per_page=10&page={}'
