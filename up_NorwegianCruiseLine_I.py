...
### 1st spider Investor Press Releases, 2nd spider Multimedia
...
class QuotessSpider(scrapy.Spider):
    name = 'NorwegianCruiseLine_I_9900213ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/NorwegianCruiseLine_I_9900213ARV001/',
        }
    #custom_settings = {
    ...
    def start_requests(self):  # follow drop down menue for different years
         ...
         for year in years:
             aux_url = 'http://www.nclhltdinvestor.com/press-releases?field_nir_news_date_value%5Bmin%5D=&items_per_page=50&page={}'
    ...
    def parse_next(self, response):
          ...
          for aux in auxs[0:20]:
              ...
              #        }
              base_url = 'http://www.nclhltdinvestor.com'
    ...
    def parse_details(self, response):
        ...
        name_regex = r'(Forward(.|\s*)Looking\s*Statements)(.|\s)*|(\bABOUT\s*Norwegian\s*Cruise\b)(.|\s)*|(\bABOUT.Norwegian.Cruise\b)(.|\s)*' #|(\bABOUT\s*L\s*BRANDS\b)(.|\s)*'
