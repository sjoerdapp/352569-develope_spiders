...
class QuotessSpider(scrapy.Spider):
    name = 'LasVegasSands_9900341ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/LasVegasSands_9900341ARV001/',
        }
    #custom_settings = {
    ...
    def start_requests(self):
        headers = {
            ...
            'Origin': 'https://investor.sands.com',
            'Referer': 'https://investor.sands.com/press-releases/default.aspx',
            'Sec-Fetch-Mode': 'cors',
        ...
        data = {"serviceDto":{"ViewType":"2","ViewDate":"","RevisionNumber":"1","LanguageId":"1","Signature":"","ItemCount":-1,"StartIndex":0,"TagList":[],"IncludeTags":True},"pressReleaseCategoryWorkflowId":"1cb807d2-208f-4bc3-9133-6a9ad45ac3b0","pressReleaseBodyType":0,"pressReleaseSelection":3,"excludeSelection":0,"year":-1}
        #for year in list(range(2009, 2020)):  # loop iterating over different pages of ajax request
        #data["year"] = year
        s_url = 'https://investor.sands.com/Services/PressReleaseService.svc/GetPressReleaseList'
    ...
    def parse(self, response):
          ...
          for dat in body['GetPressReleaseListResult']:
              ...
              #        }
              base_url = 'https://investor.sands.com/'
    ...
    def parse_details(self, response):
        ...
        name_regex_2= r'(\bAbout\s*Las\s*Vegas\s*Sands\b)(.|\s)*|(\bAbout.Las.Vegas.Sands\b)(.|\s)*|(\bABOUT\s*LAS\s*VEGAS\s*SANDS\b)(.|\s)*|(\bABOUT\s*Las\s*Vegas\s*Sands)(.|\s)*'
