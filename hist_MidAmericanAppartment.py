...
### Mid American Apartment Communities Inc. 1|1
...
class QuotessSpider(scrapy.Spider):
    name = 'MidAmericanApartement_3010400ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/MidAmericanApartement_3010400ARV001/',
    ...
    def parse(self, response):  # follow drop down menue for different years
         years = list(range(0, 82)) # fill in years which should be scraped, always last yeat +1 as upper bound will not be element of the list
         #del years[0]  # delets first element "NULL" from list of years
         for year in years:
             aux_url = 'http://ir.maac.com/News/103123/NewsData?pageIndex={}'
    ...
    def parse_details(self, response):
        ...
        name_regex_2=r'(\bAbout\s*MAA)(.|\s)*|(\bAbout.MAA\b)(.|\s)*|(\bABOUT.MAA\b)(.|\s)*|(\bABOUT\s*.MAA\b)(.|\s)*'
