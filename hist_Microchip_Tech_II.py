...
class QuotesInfiniteScrollSpider(scrapy.Spider):
    name = "Mic_Tech_II_1202700ARV002"
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/Mic_Tech_II_1202700ARV002/',
        }
    ...
    start_urls = [
                'https://www.microchip.com/documentlisting/product-headlines/1',
                'https://www.microchip.com/documentlisting/product-headlines/2',
                'https://www.microchip.com/documentlisting/product-headlines/3',
                'https://www.microchip.com/documentlisting/product-headlines/4',
                'https://www.microchip.com/documentlisting/product-headlines/5',
                'https://www.microchip.com/documentlisting/product-headlines/6',
                ] 
