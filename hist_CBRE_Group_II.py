...
class QuotessSpider(scrapy.Spider):
    ...
    def parse(self, response):  # follow drop down menue for different years
         years = list(range(1, 47)) # fill in years which should be scraped, always last yeat +1 as upper bound will not be element of the list
         #del years[0]  # delets first element "NULL" from list of years
         for year in years:
             aux_url_I = 'https://www.cbre.us/api/searchapi/mediasearch?pg='
             aux_url_II ='&t=&xt=case%20study&k=&yrs=&cats=&cin={E89A8224-DF83-411A-9AD6-A63B1776F857}&pi=617f69b3be70479f981205544476da03&lp=4e73f72b31034db5b899005cc2350fd4'
    ...
    def parse_next(self, response):
          ...
          for aux in body['Results']:
              ...
              item['HEADLINE']= aux['CompositeTitle']
    ...
    def parse_details(self, response):
        ...
        if '.pdf' in response.url.lower() or 'external.file' in response.url.lower():
            ...
            item['DESCRIPTION'] = re.sub(name_regex,'' ," ".join(response.xpath('//div[contains(@class, "main-content")]//div[contains(@class, "body-content")][1]//text()[not(ancestor::div[@class="box__right"] or self::style or self::script or ancestor::style or ancestor::script or ancestor::p[@id="news-body-cta"] or ancestor::div[@id="bwbodyimg"])]').extract()), flags=re.IGNORECASE)
            item['DOCLINK'] = response.url
