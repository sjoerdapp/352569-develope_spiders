...
### UPDATES
### get latest 25 news
### Achtung nr of tables in XML changes often
...
class QuotessSpider(scrapy.Spider):
    ...
    #}
    start_urls = ['https://ir.labcorp.com/news-releases?b6fb09dc_year%5Bvalue%5D=_none&op=Filter&b6fb09dc_widget_id=b6fb09dc&form_build_id=form-NfJfk0r-y2mw93z0lmi8VzstPSBGhZ1gsY5go7gYMQo&form_id=widget_form_base']
