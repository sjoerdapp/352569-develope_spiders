...
class QuotessSpider(scrapy.Spider):
    name = 'ArthurGallagher_I_7094000ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/ArthurGallagher_I_7094000ARV001/',
        }
    #custom_settings = {
    ...
    def start_requests(self):  # follow drop down menue for different years
         ...
         for year in years:
             aux_url = 'https://investor.ajg.com/press-releases?field_nir_news_type_target_id%5B3886%5D=3886&items_per_page=70&page={}'
             year_url = [aux_url.format(year)][0]
             yield scrapy.Request(url=year_url, callback=self.parse_next)

    def parse_next(self, response):
          auxs = response.xpath('//table[contains(@class, "news-table")]//tr[not(ancestor::thead)]')
          for aux in auxs:
              ...
              #        }
              base_url = 'https://investor.ajg.com'
