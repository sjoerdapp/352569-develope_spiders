...
class QuotessSpider(scrapy.Spider):
    ...
    def parse(self, response):  # follow drop down menue for different years
         ...
         for year in years:
             aux_url = 'https://investors.f5.com/news-and-events/news/default.aspx'
    ...
    def parse_next(self, response):
          ...
          for aux in auxs:
              ...
              item['PUBSTRING'] = aux.xpath('.//span[@class="module_date-text"]/text()').extract_first() #.split('|')[1] # cuts out the part berfore the date as well as the /n at the end of the string
              ...
              #        }
              base_url = 'https://investors.f5.com/'
