...
class QuotessSpider(scrapy.Spider):
    ...
    #}
    start_urls = ['http://ir.hcpi.com/news-releases']

    def parse(self, response):  # follow drop down menue for different years
         years = list(range(0, 152, 25)) # fill in years which should be scraped, always last yeat +1 as upper bound will not be element of the list
