...
### 1st spider Investor NEWS, 2nd spider latest News
### classic post
### back to 20050120


class QuotessSpider(scrapy.Spider):
    name = 'whirlpool_I_2191600ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/whirlpool_I_2191600ARV001/',
        }
    #custom_settings = {
    ...
    def start_requests(self):
        headers = {
            ...
            'Origin': 'https://investors.whirlpoolcorp.com',
            'Referer': 'https://investors.whirlpoolcorp.com/news-and-events/news/default.aspx',
        ...
        for year in list(range(2005, 2020)):  # loop iterating over different pages of ajax request
            data["year"] = year
            s_url = 'https://investors.whirlpoolcorp.com/Services/PressReleaseService.svc/GetPressReleaseList'
    ...
    def parse(self, response):
          ...
          for dat in body['GetPressReleaseListResult']:
              ...
              #        }
              base_url = 'https://investors.whirlpoolcorp.com'
