...
### 1st spider IR, 2nd spider News articles
### normal get 
### back to 20020208


class QuotessSpider(scrapy.Spider):
    name = 'CenterP_I_2093900ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/CenterP_I_2093900ARV001/',
        }
    #custom_settings = {
    ...
    #}
    start_urls = ['http://investors.centerpointenergy.com/press-releases']
    ...
    def parse_next(self, response):
          auxs = response.xpath('//table[@class="nirtable dataTable"]//tr')
          for aux in auxs:
              ...
              #        }
              base_url = 'http://investors.centerpointenergy.com'
