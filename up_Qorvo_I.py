...
### Qorvo Inc. 1|2
### 1st IR Press Releases, 2nd spider Newsroom 
### normal get 
### back to 20021003


class QuotessSpider(scrapy.Spider):
    name = 'Qorvo_I_1550600ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/Qorvo_I_1550600ARV001/',
        }
    #custom_settings = {
