...
### UPDATES
### get latest 20 news, 50 items per page

### Leggett & Platt Incorporated 1|1
...
class QuotessSpider(scrapy.Spider):
    name = 'Leggett_2636000ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/Leggett_2636000ARV001/',
        }
    #custom_settings = {
    ...
    #}
    start_urls = ['https://leggett.gcs-web.com']
    ...
    def parse_next(self, response):
          ...
          for aux in auxs[0:20]:
              ...
              #        }
              base_url = 'https://leggett.gcs-web.com'
    ...
    def parse_details(self, response):
        ...
        name_regex = r'(Forward(.|\s*)Looking\s*Statements)(.|\s)*|(This\s*news\s*release\s*includes\s*"forward-looking"\s*statements)(.|\s)*'
        name_regex_2=r'(\bCOMPANY\s*DESCRIPTION\b)(.|\s)*|(\bCOMPANY.DESCRIPTION\b)(.|\s)*'
