...
### UPDATES
### current year, break if more than 20 news

### Parker Hanfin Corporation 3|4
### 3rd spider Investor Press Releases, 4th spider News Releases
...
class QuotessSpider(scrapy.Spider):
    name = 'ParkerHannifin_III_2136700ARV003'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/ParkerHannifin_III_2136700ARV003/',
        }
    #custom_settings = {
    ...
    def parse(self, response):  # follow drop down menue for different years
         ...
         for year in years:
             aux_url = 'https://investors.parker.com/financial-news/financial-news-releases?a89c091f_year%5Bvalue%5D={}&op=Filter&a89c091f_widget_id=a89c091f&form_build_id=form-YAhNIHudXprIZ1f5gUQ5roH94Qr0MLYjz8AhLsTlKfI&form_id=widget_form_base'
    ...
    def parse_next(self, response):
          ...
          for aux in auxs:
              ...
              #        }
              base_url = 'https://investors.parker.com'
