...
### Unum Group 1|3
### 1st IR PRESS RELEASES, 2nd Newsroom Press Releases, 3rd newsroom Articles, cutomer testimonials left out
### originally post but works with normal get
### back to 20020531


class QuotessSpider(scrapy.Spider):
    name = 'UNUM_I_2179800ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/UNUM_I_2179800ARV001/',
        }
    #custom_settings = {
    ...
    #}
    start_urls = ['https://investors.unum.com']

    def parse(self, response):  # follow drop down menue for different years
         years = list(range(0, 144)) # fill in years which should be scraped, always last yeat +1 as upper bound will not be element of the list
         #del years[0]  # delets first element "NULL" from list of years
         for year in years:
             aux_url = 'https://investors.unum.com/News/103324/NewsData?pageIndex={}'
    ...
    def parse_next(self, response):
          ...
          for aux in auxs:
              ...
              #        }
              base_url = 'https://investors.unum.com'
