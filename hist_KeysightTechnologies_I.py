...
### normal get request 
### goes back to 20130919


class QuotesInfiniteScrollSpider(scrapy.Spider):
    name = "KeysightTechnologies_I_5503300ARV001"
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/KeysightTechnologies_I_5503300ARV001/',
        }
    ...
    def parse_next(self, response):
        auxs = response.xpath('//div[contains(@class, "module_item")]')
        for aux in auxs:
            ...
            #        }
            base_url = 'https://investor.keysight.com'
