...
class QuotessSpider(scrapy.Spider):
    ...
    #}
    start_urls = ['https://www.thehersheycompany.com/bin/ssf/nasdaqNewsRelease']
    ...
    def parse(self, response):
          ...
          for aux in body['Record'][0:30]:
              ...
              #        }
              base_url = 'https://www.thehersheycompany.com/bin/ssf/nasdaqNewsRelease?releaseId='
