...
### UPDATES
### actual month einstellen
### acutal month, latest 20 news
...
class QuotessSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        yield scrapy.http.FormRequest.from_response(
            ...
            formdata={
                ...
                "ctl00$PlaceHolderMain$NewsArchive$cboFromDateYear": "2019",
                "ctl00$PlaceHolderMain$NewsArchive$cboToDateMonth": "1",
                "ctl00$PlaceHolderMain$NewsArchive$cboToDateYear": "2020",
                "ctl00$PlaceHolderMain$NewsArchive$cboDisplayPerPage": "25",
    ...
    def parse_news_page(self, response):
          ...
          auxs = response.xpath('//a[@class="newsRelease"]')[0:20]
          for aux in auxs:
