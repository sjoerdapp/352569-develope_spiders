...
### UPDATES
### approx, latest 20 news

### JB Hund Transport Services 2|2
### second spider Company News
### normal get with json 
### seems all news are pdf
### back to 20020409


class QuotessSpider(scrapy.Spider):
    name = 'JB_HuntTransport_II_6606000ARV002'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/JB_HuntTransport_II_6606000ARV002/',
        }
    #custom_settings = {
    ...
    #}
    start_urls = ['https://ww3.jbhunt.com/files/newsroom/list/company_news/?ver=1563461167549',
                  #'https://ww3.jbhunt.com/files/newsroom/list/company_news/12-05-2018?ver=1563461189843'
                  ]
    ...
    def parse(self, response):
          ...
          for aux in body[0:20]:
              item = SwisscomIvCrawlerItem()
              timestamp = aux['PublishDate'].split('Date(')[1].split(')')[0]
              ...
              item['HEADLINE']= aux['DocumentTitle']
              item['DOCLINK']= aux['ContentUrl']
              #item = {
              #        'PUBSTRING': aux.xpath('./p[@class="news-card-date"]//text()').extract()[1],
              #        'HEADLINE': aux.xpath('.//h3[@class="news-card-title"]/a//text()').extract_first(),
              #        'DOCLINK': aux.xpath('.//h3[@class="news-card-title"]/a/@href').extract_first(),
              #        }
              base_url = 'https://ww3.jbhunt.com'
