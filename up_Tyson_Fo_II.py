...
### UPDATES
### get first page / 20 news per page ; 
### ACHTUNG at the moment first two pages to correct for potential error!!!!
...
class QuotesInfiniteScrollSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.tysonfoods.com/news/news-releases'] 
    ...
    def parse_next(self, response):
        auxs = response.xpath('//div[@class="node__content"]//div[@class="views-row"]//article[contains(@class, "node")]')
        for aux in auxs:
