...
class QuotesInfiniteScrollSpider(scrapy.Spider):
    ...
    start_urls = ['https://pplweb.mediaroom.com/news-releases?o=0'] 

    
    def parse(self, response):  # follow drop down menue for different years
         years = list(range(0,2210,25)) # 2200fill in years which should be scraped, always last yeat +1 as upper bound will not be element of the list
