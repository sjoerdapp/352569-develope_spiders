...
class QuotessSpider(scrapy.Spider):
    name = 'Kimco_I_2933500ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/Kimco_I_2933500ARV001/',
        }
    #custom_settings = {
    ...
    #}
    #start_urls = ['https://investors.kimcorealty.com/News']
    ...
    def start_requests(self):  # follow drop down menue for different years
         ...
         for year in years:
             aux_url = 'https://investors.kimcorealty.com/News/102965/NewsData?pageIndex={}'
    ...
    def parse_next(self, response):
          ...
          for aux in auxs:
              ...
              item['HEADLINE']= aux.xpath('.//div/a[@class="irwGaLabel irwEventTracking irwGaHasFile"]/text()').extract_first()
              item['DOCLINK']= aux.xpath('.//div/a[@class="irwGaLabel irwEventTracking irwGaHasFile"]/@href').extract_first()
              #item = {
              #        'PUBSTRING': aux.xpath('./p[@class="news-card-date"]//text()').extract()[1],
              #        'HEADLINE': aux.xpath('.//h3[@class="news-card-title"]/a//text()').extract_first(),
              #        'DOCLINK': aux.xpath('.//h3[@class="news-card-title"]/a/@href').extract_first(),
              #        }
              base_url = 'https://investors.kimcorealty.com'
    ...
    def parse_details(self, response):
        ...
        name_regex_2=r'(\bAbout\s*Kimco\b)(.|\s)*|(\bAbout.Kimco\b)(.|\s)*|(\bABOUT.KIMCO\b)(.|\s)*'
