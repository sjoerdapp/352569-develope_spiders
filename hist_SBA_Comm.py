...
class QuotessSpider(scrapy.Spider):
    name = 'SBA_Comm_9900203ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/SBA_Comm_9900203ARV001/',
        }
    #custom_settings = {
    ...
    def start_requests(self):
        ...
        data = {"serviceDto":{"ViewType":"2","ViewDate":"","RevisionNumber":"1","LanguageId":"1","Signature":"","ItemCount":-1,"StartIndex":0,"TagList":[],"IncludeTags":True},"pressReleaseCategoryWorkflowId":"1cb807d2-208f-4bc3-9133-6a9ad45ac3b0","pressReleaseBodyType":0,"pressReleaseSelection":3,"excludeSelection":1,"year":1998}
    ...
    def parse_details(self, response):
        ...
        name_regex = r'(Information\s*Concerning\s*Forward(.|\s*)Looking\s*Statements)(.|\s)*|(SBA\s*Communications\s*Corporation\s*is\s*a\s*first\s*choice)(.|\s)*|(\bABOUT\s*SBA\b)(.|\s)*|(\bABOUT.SBA\b)(.|\s)*' #|(\bABOUT\s*L\s*BRANDS\b)(.|\s)*'
