...
class QuotessSpider(scrapy.Spider):
    name = 'Hasbro_I_2088700ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/Hasbro_I_2088700ARV001/',
        }
    #custom_settings = {
    ...
    #}
    start_urls = ['https://investor.hasbro.com']
    ...
    def parse(self, response):  # follow drop down menue for different years
         ...
         for year in years:
             aux_url = 'https://investor.hasbro.com/press-releases?field_nir_news_date_value%5Bmin%5D=&items_per_page=50&field_nir_news_category_target_id%5B4176%5D=4176&field_nir_news_category_target_id%5B4206%5D=4206&field_nir_news_category_target_id%5B4226%5D=4226&page={}'
    ...
    def parse_next(self, response):
          ...
          for aux in auxs:
              ...
              #        }
              base_url = 'https://investor.hasbro.com'
    ...
    def parse_details(self, response):
        ...
        name_regex =r'(Forward(.|\s*)Looking\s*Statements)(.|\s)*|(\bABOUT\s*Hasbro\b)(.|\s)*|(\bABOUT.Hasbro\b)(.|\s)*'
