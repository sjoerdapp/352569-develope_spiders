...
### UPDATES
### get actual year, sto if more than 20 news

### IPG Photonics Corporation 1|1
...
class QuotessSpider(scrapy.Spider):
    name = 'IPG_photonics_5155500ARV001'
    custom_settings = {
         'CRAWLERA_ENABLED': False,
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/IPG_photonics_5155500ARV001/',
        }
    #custom_settings = {
    ...
    def start_requests(self):
        headers = {
            ...
            'Origin': 'https://investor.ipgphotonics.com',
            'Referer': 'https://investor.ipgphotonics.com/press-releases/default.aspx',
        ...
        for year in list(range(2019, 2021)):  # loop iterating over different pages of ajax request
            data["year"] = year
            s_url = 'https://investor.ipgphotonics.com/Services/PressReleaseService.svc/GetPressReleaseList'
    ...
    def parse(self, response):
          ...
          for dat in auxs:
              ...
              #        }
              base_url = 'https://investor.ipgphotonics.com'
    ...
    def parse_details(self, response):
        ...
        name_regex_2=r'(\bAbout\s*IPG\b)(.|\s)*|(\bAbout.IPG\b)(.|\s)*'
