...
class QuotessSpider(scrapy.Spider):
    ...
    #}
    start_urls = ['http://pressroom.grainger.com/phoenix.zhtml?c=194987&p=irol-news']
    ...
    def parse(self, response):
          auxs = response.xpath('//div[@id="static"]/table[5]/tr/td/table/tr[not(contains(@class, "Ttl"))]')
          for aux in auxs:
