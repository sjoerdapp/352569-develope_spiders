...
### UPDATES
### latest 20 news, all news in one page

### E*trade Financial Corporation 2|2
### 2nd spider archive
### get with xpath, probably only pdfs
### back to 20050106


class QuotessSpider(scrapy.Spider):
    name = 'E-Trade_II_1491500ARV002'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/E-Trade_II_1491500ARV002/',
        }
    #custom_settings = {
    ...
    #}
    start_urls = ['https://about.etrade.com/newsroom/press-releases/library']
    ...
    def parse(self, response):
          auxs = response.xpath('//div[@class="panel-body"]//table//tr')
          for aux in auxs[0:20]:
              item = SwisscomIvCrawlerItem()
              item['PUBSTRING'] = aux.xpath('./td[not(child::a)]/text()').extract_first() # cuts out the part berfore the date as well as the /n at the end of the string
