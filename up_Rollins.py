...
### UPDATES
### actual year, stop if more than 20 news

### Rollins Inc. 1||1
### 1 spider NEWS
### normal get request, years back to 2013 rest comes in archive
### need to follow pagination links
#back to 20030103


class QuotesInfiniteScrollSpider(scrapy.Spider):
    name = "Rollins_2153000ARV001"
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/Rollins_2153000ARV001/',
        }
    ...
    start_urls = ['https://www.rollins.com'] 
    ...
    def parse(self, response):  # follow drop down menue for different years
         ...
         years.append('archive') #del years[0]  # delets first element "NULL" from list of years
         for year in years:
             aux_url = 'https://www.rollins.com/news/{}'
    ...
    def parse_next(self, response):
        ...
        for aux in auxs:
            ...
            item['PUBSTRING'] = aux.xpath('.//th[@class="pr-date-field"]/text()[2]').extract_first()
            ...
            #        }
            base_url = 'https://www.rollins.com'
        ...
        #if next_page_url:
        #    next_page_url = 'https://www.rollins.com' + next_page_url
    ...
    def parse_details(self, response):
        ...
        if '.pdf' in response.url.lower():
            ...
            name_regex = r'(Forward(.|\s*)Looking\s*Statements)(.|\s)*|(Rollins.\s*Inc.\s*is\s*a\s*premier\s*global\s*consumer\s*and\s*commercial)(.|\s)*|(Rollins\s*Inc.\s*is\s*a\s*premier\s*North\s*American\s*consumer\s*and\s*commercial)(.|\s)*'
            name_regex_2=r'(\bAbout\s*Rollins\b)(.|\s)*|(\bAbout.Rollins\b)(.|\s)*|(\bABOUT.ROLLINS\b)(.|\s)*'
