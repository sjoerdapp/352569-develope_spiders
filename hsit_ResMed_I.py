...
class QuotesInfiniteScrollSpider(scrapy.Spider):
    ...
    def start_requests(self):  # follow drop down menue for different years
         ...
         for year in years:
             aux_url = 'https://investors.resmed.com/investor-relations/events-and-presentations/{}/default.aspx'
    ...
    def parse_next(self, response):
        auxs = response.xpath('//div[@class="ModuleContainer ModulePressRelease"]//div[contains(@class, "ModuleItem")]')
        for aux in auxs:
