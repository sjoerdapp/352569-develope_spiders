...
### UPDATES
### actual year, get latest 20 news (first page)

### Fleetcor Technonolgies Inc. 1|2
...
class QuotessSpider(scrapy.Spider):
    name = 'FleetCor_I_9900253ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/FleetCor_I_9900253ARV001/',
        }
    #custom_settings = {
    ...
    def start_requests(self):  # follow drop down menue for different years
         ...
         for year in years:
             aux_url = 'https://fleetcor.gcs-web.com/press-releases?items_per_page=20&page={}'
    ...
    def parse_next(self, response):
          ...
          for aux in auxs:
              ...
              #        }
              base_url = 'https://fleetcor.gcs-web.com'
