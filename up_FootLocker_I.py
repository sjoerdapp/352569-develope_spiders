...
### UPDATES
### first 13 of financial and general, are on one page

### Foot Locker Inc. 1|1
### 1st spider Investor Press Releases Financial
### normal get 
### seems all pdf
### back to 20130215
...
class QuotessSpider(scrapy.Spider):
    name = 'FootLocker_2193600ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/FootLocker_2193600ARV001/',
         }
    #custom_settings = {
    ...
    def parse(self, response):
          ...
          for aux in auxs:
              ...
              #        }
              base_url = 'https://www.footlocker-inc.com'
