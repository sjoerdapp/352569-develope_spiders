...
### changed 20191209 to get aspx with json
### now latest year if more than 20 break
...
class QuotesInfiniteScrollSpider(scrapy.Spider):
    ...
    start_urls = ['https://news.lambweston.com/feed/PressRelease.svc/GetPressReleaseList?apiKey=BF185719B0464B3CB809D23926182246&LanguageId=1&bodyType=0&pressReleaseDateFilter=3&categoryId=1cb807d2-208f-4bc3-9133-6a9ad45ac3b0&pageSize=-1&pageNumber=0&tagList=&includeTags=true&year=2020&excludeSelection=1'] 
    ...
    def parse(self, response):
        ...
        for aux in auxs:
            ...
            item['PUBSTRING'] = aux['PressReleaseDate']
