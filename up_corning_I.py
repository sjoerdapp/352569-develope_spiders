...
### UPDATES
### last year, if more than 20 news than break
...
class QuotesInfiniteScrollSpider(scrapy.Spider):
    name = "CORN_I_2052300ARV001"
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/CORN_I_2052300ARV001/',
        }
    ...
    def parse(self, response):  # follow drop down menue for different years
         ...
         for year in years:
             aux_url = 'https://investor.corning.com/feed/PressRelease.svc/GetPressReleaseList?apiKey=BF185719B0464B3CB809D23926182246&LanguageId=1&bodyType=0&pressReleaseDateFilter=3&categoryId=1cb807d2-208f-4bc3-9133-6a9ad45ac3b0&pageSize=-1&pageNumber=0&tagList=&includeTags=true&year={}&excludeSelection=1'
    ...
    def parse_next(self, response):
        data = json.loads(response.text)
        auxs = data['GetPressReleaseListResult']
        if len(auxs) > 20:
            auxs = auxs[0:20]
        ...
        for prod in auxs:
            ...
            item['PUBSTRING'] = prod['PressReleaseDate']
            item['HEADLINE']= prod['Headline']
            item['DOCLINK']= prod['LinkToDetailPage']
            #item = {
            #    'PUBSTRING': prod['PressReleaseDate'],
            #    'HEADLINE' : prod['Headline'],
            #    'DOCLINK' : prod['LinkToDetailPage'],
            #    }
            base_url = 'https://investor.corning.com'
            aux_url = prod['LinkToDetailPage']
