...
### Avery Dennison Corporation 1|2
### 1st spider IR Press Releases, 2nd spider Pressroom
### normal get 
### back to 20171010


class QuotessSpider(scrapy.Spider):
    name = 'Avery_I_2023800ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/Avery_I_2023800ARV001/',
        }
    #custom_settings = {
    ...
    #}
    start_urls = ['https://www.investors.averydennison.com/news-releases?items_per_page=50#views-exposed-form-widget-news-table']
    ...
    def parse(self, response):
          ...
          for aux in auxs[0:20]:
              ...
              #        }
              base_url = 'https://www.investors.averydennison.com'
