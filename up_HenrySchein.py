...
class QuotessSpider(scrapy.Spider):
    name = 'HenrySchein_1409800ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/HenrySchein_1409800ARV001/',
        }
    #custom_settings = {
    ...
    #}
    #start_urls = ['http://phx.corporate-ir.net/phoenix.zhtml?c=74322&p=irol-news']
    ...
    def start_requests(self):  # follow drop down menue for different years
         ...
         for year in years:
             aux_url = 'http://investor.henryschein.com/press-releases?field_nir_news_date_value%5Bmin%5D={}'
    ...
    def parse_next(self, response):
          ...
          for aux in auxs:
              ...
              item['PUBSTRING'] = aux.xpath('.//td[contains(@headers, "news-date-table")]/text()').extract_first() # cuts out the part berfore the date as well as the /n at the end of the string
              item['HEADLINE']= aux.xpath('.//td[contains(@class, "cus_title")]/a/text()').extract_first()
              ...
              #        }
              base_url = 'http://investor.henryschein.com'
    ...
    def parse_details(self, response):
        ...
        name_regex_2=r'(\bAbout\s*Henry)(.|\s)*|(\bAbout.Henry\b)(.|\s)*|(\bABOUT.Henry\b)(.|\s)*|(\bABOUT\s*.HENRY\b)(.|\s)*'
