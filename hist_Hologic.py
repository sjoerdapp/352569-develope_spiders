...
class QuotessSpider(scrapy.Spider):
    name = 'Hologic_1050400ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/Hologic_1050400ARV001/',
    ...
    def start_requests(self):
        ...
        for year in list(range(2008, 2020)):  # loop iterating over different pages of ajax request
            data = 'https://investors.hologic.com/feed/PressRelease.svc/GetPressReleaseList?apiKey=BF185719B0464B3CB809D23926182246&LanguageId=1&bodyType=0&pressReleaseDateFilter=3&categoryId=1cb807d2-208f-4bc3-9133-6a9ad45ac3b0&pageSize=-1&pageNumber=0&tagList=&includeTags=true&year={}&excludeSelection=1'
    ...
    def parse(self, response):
          ...
          for dat in body['GetPressReleaseListResult']:
              ...
              #        }
              base_url = 'https://investors.hologic.com'
    ...
    def parse_details(self, response):
        ...
        name_regex = r'(Forward(.|\s*)Looking\s*Statements)(.|\s)*|(Forward(.|\s*)Looking\s*Statement\s* Disclaimer)(.|\s)*'
        name_regex_2=r'(\bAbout\s*Hologic)(.|\s)*|(\bAbout.Hologic\b)(.|\s)*|(\bABOUT.Hologic\b)(.|\s)*|(\bABOUT\s*.HOLOGIC\b)(.|\s)*'
