...
class QuotessSpider(scrapy.Spider):
    name = 'Juniper_I_1661400ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/Juniper_I_1661400ARV001/',
        }
    #custom_settings = {
    ...
    #}
    start_urls = ['https://investor.juniper.net']
    ...
    def parse(self, response):  # follow drop down menue for different years
         ...
         for year in years:
             aux_url = 'https://investor.juniper.net/investor-relations/press-releases/{}/default.aspx'
             year_url = [aux_url.format(year)][0]
             yield scrapy.Request(url=year_url, callback=self.parse_next)

    def parse_next(self, response):
          auxs = response.xpath('//div[@class="ModuleContainerInnerTop"]/div[@class="ModuleContainerInner"]/div[contains(@class, "ModuleItem")]')
          for aux in auxs:
              ...
              #        }
              base_url = 'https://investor.juniper.net'
