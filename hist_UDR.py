...
class QuotessSpider(scrapy.Spider):
    name = 'UDR_3334000ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/UDR_3334000ARV001/',
    ...
    def start_requests(self):
         ...
         years = list(range(0, 52)) # fill in years which should be scraped, always last yeat +1 as upper bound will not be element of the list
         #del years[0]  # delets first element "NULL" from list of years
         for year in years:
             aux_url = 'http://ir.udr.com/News/103025/NewsData?pageIndex={}'
    ...
    def parse_details(self, response):
        ...
        name_regex_2=r'(\bAbout\s*UDR)(.|\s)*|(\bAbout.UDR\b)(.|\s)*|(\bABOUT.UDR\b)(.|\s)*|(\bABOUT\s*.UDR\b)(.|\s)*'
