...
### UPDATES
### actual year, breack after 20 news

### Pentair plc. 1|2
### 1st spider Investor Press Releases, 2nd spider Press Releases, not needed as it contains same as first
### normal get 
### back to 20000131


class QuotessSpider(scrapy.Spider):
    name = 'Pentair_I_5418500ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/Pentair_I_5418500ARV001/',
        }
    #custom_settings = {
    ...
    #}
    start_urls = ['https://investors.pentair.com']
    ...
    def parse_next(self, response):
          ...
          for aux in auxs:
              ...
              #        }
              base_url = 'https://investors.pentair.com'
    ...
    def parse_details(self, response):
        ...
        name_regex_2=r'(\bAbout\s*Pentair)(.|\s)*|(\bAbout.Pentair)(.|\s)*|(\bABOUT.PENTAIR)(.|\s)*'
