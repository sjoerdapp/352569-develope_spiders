...
### Alliance Data Systems Corporation 1|1
...
class QuotessSpider(scrapy.Spider):
    name = 'AllianceDataSys_4167100ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/AllianceDataSys_4167100ARV001/',
        }
    #custom_settings = {
    ...
    def start_requests(self):
        ...
        for year in years:
            aux_url = 'https://www.alliancedata.com/feed/PressRelease.svc/GetPressReleaseList?apiKey=BF185719B0464B3CB809D23926182246&LanguageId=1&bodyType=0&pressReleaseDateFilter=3&categoryId=1cb807d2-208f-4bc3-9133-6a9ad45ac3b0&pageSize=-1&pageNumber=0&tagList=&includeTags=true&year={}&excludeSelection=1'
    ...
    def parse_next(self, response):
          ...
          for dat in body['GetPressReleaseListResult']:
              ...
              #        }
              base_url = 'https://www.alliancedata.com'
    ...
    def parse_details(self, response):
        ...
        name_regex_2=r'(\bAbout\s*Alliance\b)(.|\s)*|(\bAbout.Alliance\b)(.|\s)*|(\bABOUT.ALLIANCE\b)(.|\s)*'
