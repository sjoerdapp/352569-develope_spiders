...
### CarMax Inc. 1|2
### 1st spider Investor NEWS RELEASES, 2nd spider Media releases
### classic post with payload, all data comes in one request
### back to 20030221
...
class QuotessSpider(scrapy.Spider):
    name = 'CarMax_I_4351900ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/CarMax_I_4351900ARV001/',
        }
    #custom_settings = {
    ...
    def start_requests(self):
        headers = {
            ...
            'Origin': 'http://investors.carmax.com',
            'Referer': '//investors.carmax.com/news-releases/default.aspx',
        ...
        data = {"serviceDto":{"ViewType":"2","ViewDate":"","RevisionNumber":"1","LanguageId":"1","Signature":"","ItemCount":-1,"StartIndex":0,"TagList":[],"IncludeTags":True},"pressReleaseSelection":3,"pressReleaseBodyType":3,"pressReleaseCategoryWorkflowId":"00000000-0000-0000-0000-000000000000","year":-1}
        #for year in list(range(2009, 2020)):  # loop iterating over different pages of ajax request
        #    data["year"] = year
        s_url = 'http://investors.carmax.com/Services/PressReleaseService.svc/GetPressReleaseList'
    ...
    def parse(self, response):
          ...
          for dat in body['GetPressReleaseListResult'][0:20]:
              ...
              #        }
              base_url = 'http://investors.carmax.com'
