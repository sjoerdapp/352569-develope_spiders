...
### Trip Advisor Inc. 2|3
### 2nd Press Releases, 3rd in the News
### normal get 
### back to 20001207


class QuotessSpider(scrapy.Spider):
    name = 'TripAdvisor_II_5396400ARV002'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/TripAdvisor_II_5396400ARV002/',
        }
    #custom_settings = {
    ...
    def parse(self, response):  # follow drop down menue for different years
         ...
         for year in years:
             aux_url = 'https://tripadvisor.mediaroom.com/us-press-releases?l=50&o={}'
