...
### Brown Forman Corporation 1|1
### 1st spider Investor Press Releases
### originally post but works with normal get 
### back to 20060719

class QuotessSpider(scrapy.Spider):
    name = 'BrownForman_2034000ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/BrownForman_2034000ARV001/',
        }
    #custom_settings = {
    ...
    #}
    start_urls = ['https://www.brown-forman.com/']
    ...
    def parse(self, response):  # follow drop down menue for different years
         ...
         for year in years:
             aux_url = 'https://investors.brown-forman.com/News/4086734/NewsData?pageIndex={}'
    ...
    def parse_next(self, response):
          ...
          for aux in auxs:
              ...
              #        }
              base_url = 'https://investors.brown-forman.com'
    ...
    def parse_details(self, response):
        ...
        name_regex_2=r'(\bAbout\s*Brown)(.|\s)*|(\bAbout.Brown\b)(.|\s)*|(\bABOUT.BROWN\b)(.|\s)*'
