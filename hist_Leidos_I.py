...
class QuotessSpider(scrapy.Spider):
    name = 'Leidos_I_5133800ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/Leidos_I_5133800ARV001/',
        }
    #custom_settings = {
    ...
    def start_requests(self):
        headers = {
            ...
            'Origin': 'https://investors.leidos.com',
            'Referer': 'https://investors.leidos.com/news-and-events/news-releases/default.aspx',
            'Sec-Fetch-Mode': 'cors',
        ...
        for year in list(range(2004, 2021)):  # loop iterating over different pages of ajax request
            data["year"] = year
            s_url = 'https://investors.leidos.com/Services/PressReleaseService.svc/GetPressReleaseList'
    ...
    def parse(self, response):
          ...
          for dat in body['GetPressReleaseListResult']:
              ...
              #        }
              base_url = 'https://investors.leidos.com/'
    ...
    def parse_details(self, response):
        ...
        name_regex_2= r'(\bAbout\s*Leidos\b)(.|\s)*|(\bAbout.Leidos\b)(.|\s)*|(\bAbout. Leidos\b)(.|\s)*|(\bABOUT\s*LEIDOS\b)(.|\s)*|(\bABOUT\s*Leidos)(.|\s)*'
