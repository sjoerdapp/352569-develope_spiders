...
class QuotessSpider(scrapy.Spider):
    ...
    def start_requests(self):
        headers = {
            ...
            'Origin': 'https://investor.fastenal.com',
        ...
        for year in list(range(2004, 2020)):  #2004 loop iterating over different pages of ajax request
            data["year"] = year
            s_url = 'https://investor.fastenal.com/Services/PressReleaseService.svc/GetPressReleaseList'
    ...
    def parse_details(self, response):
        ...
        name_regex_2=r'(\bAbout\s*Fastenal)(.|\s)*|(\bAbout.Fastenal\b)(.|\s)*|(\bABOUT.Fastenal\b)(.|\s)*|(\bABOUT\s*.FASTENAL\b)(.|\s)*'
