...
class QuotessSpider(scrapy.Spider):
    ...
    #}
    start_urls = ['https://invest.grainger.com/feed/PressRelease.svc/GetPressReleaseList?apiKey=BF185719B0464B3CB809D23926182246&LanguageId=1&bodyType=0&pressReleaseDateFilter=3&categoryId=1cb807d2-208f-4bc3-9133-6a9ad45ac3b0&pageSize=-1&pageNumber=0&tagList=&includeTags=true&year=2020&excludeSelection=1']
    ...
    def parse(self, response):
          ...
          #auxs = response.xpath('//div[@class="irContent"]/table[4]/tr/td/table/tr[not(contains(@class, "Ttl"))]')[0:20]
          #for aux in auxs:
          #    item = SwisscomIvCrawlerItem()
