...
### Tyson Foods Inc 1|2
### 1st IR NEWS get request with standard json ;2nd spider standard News Reseases get with xpath
### normal get request with standard json 'GetPress....'
### history back to 2011 even so page says just to 2017'
### back to 20110106


class QuotesInfiniteScrollSpider(scrapy.Spider):
    name = "Tyson_Fo_I_4620000ARV001"
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/Tyson_Fo_I_4620000ARV001/',
        }
    ...
    def parse(self, response):  # follow drop down menue for different years
         ...
         for year in years:
             aux_url = 'https://ir.tyson.com/feed/PressRelease.svc/GetPressReleaseList?apiKey=BF185719B0464B3CB809D23926182246&LanguageId=1&bodyType=0&pressReleaseDateFilter=3&categoryId=1cb807d2-208f-4bc3-9133-6a9ad45ac3b0&pageSize=-1&pageNumber=0&tagList=&includeTags=true&year={}&excludeSelection=1'
