...
### WestRock Company 2|3
### 2nd NewsRoom Press Releases, 3rd Product News
### normal get with json
### back to 20160115


class QuotessSpider(scrapy.Spider):
    name = 'WestRock_II_2191300ARV002'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/WestRock_II_2191300ARV002/',
        }
    #custom_settings = {
    ...
    def parse(self, response):  # follow drop down menue for different years
         years = list(range(0,101, 20)) # fill in years which should be scraped, always last yeat +1 as upper bound will not be element of the list
         #del years[0]  # delets first element "NULL" from list of years
         for year in years:
             aux_url = 'https://www.westrock.com/api/sitecore/News/GetMoreNews?startIndex={}&limit=20&itemId=78c5133d-d1bc-4598-aa1e-b90066dafaff'
