...
### normal get, all news in one page only short history 
### back to 20181212


class QuotessSpider(scrapy.Spider):
    name = 'NVR_Inc_2124200ARV001'
    custom_settings = {
         'JOBDIR' : 'None',
         'FILES_STORE' : 's3://352569/NVR_Inc_2124200ARV001/',
        }
    #custom_settings = {
    ...
    #}
    start_urls = ['https://nvri.gcs-web.com/news-releases']
    ...
    def parse(self, response):
          ...
          for aux in auxs:
              ...
              #        }
              base_url = 'https://nvri.gcs-web.com'
    ...
    def parse_details(self, response):
        ...
        name_regex_2=r'(\bAbout\s*NVR)(.|\s)*|(\bAbout.NVR\b)(.|\s)*|(\bABOUT.NVR\b)(.|\s)*|(\bABOUT\s*.NVR\b)(.|\s)*'
