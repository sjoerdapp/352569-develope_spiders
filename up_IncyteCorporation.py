...
class QuotesInfiniteScrollSpider(scrapy.Spider):
    ...
    def start_requests(self):  # follow drop down menue for different years
         years = list(range(0, 2)) #12 fill in years which should be scraped, always last yeat +1 as upper bound will not be element of the list
         #del years[0]  # delets first element "NULL" from list of years
         for year in years:
             aux_url = 'https://investor.incyte.com/incyte-news/press-releases?page={}'
    ...
    def parse_next(self, response):
        ...
        for aux in auxs:
            ...
            item['PUBSTRING'] = aux.xpath('.//p[@class="date-convert"]/text()').extract_first()
            item['HEADLINE']= aux.xpath('.//div[@class="col-lg-7 col-xs-6 col-md-8 col-sm-8"]//p/text()').extract_first()
            item['DOCLINK']= aux.xpath('.//div[@class="col-lg-2 col-xs-3 col-md-2 col-sm-2 download-img pull-right text-center"]//a/@href').extract_first()
            #item = {
